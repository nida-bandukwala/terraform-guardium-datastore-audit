...
data "aws_db_instance" "existing" {
  db_instance_identifier = var.mysql_rds_cluster_identifier
}
...
import {
  ...
  to       = module.datastore-audit_aws-mysql-rds-audit.module.common_rds-mariadb-mysql-parameter-group.aws_db_parameter_group.db_param_group
  id       = local.pg_name
}
...
import {
  ...
  to       = module.datastore-audit_aws-mysql-rds-audit.module.common_rds-mariadb-mysql-parameter-group.aws_db_option_group.audit
  id       = local.og_name
}